...
/////////////////
const BotName = 'LORENZO-BOT'; 
const instagram = 'MALES ANJER'; 
const telegram = 'https://t.me/@cyberhuntermap'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/@jjlorenzo4248';
//const grupch1 = 'https://chat.whatsapp.com/EoqQJf7OiGl5boMGKc2E0j'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot By LORENZO')
